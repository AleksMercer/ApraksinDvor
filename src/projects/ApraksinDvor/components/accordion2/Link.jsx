      ...
      <section className='link-usage'>
        ...
        <div className='link-usage__container'>
          ...
          <div className='link-usage__container-text'>
            ...
            <p className='link-usage__container-text-list'>Используйте ссылки в&nbsp;следующих случаях:
              <ul> 
                <li>Для перехода на&nbsp;другую страницу внутри продукта;</li>
                <li>Для перехода на&nbsp;другой сайт;</li>
                <li>Для перехода к&nbsp;элементу на&nbsp;той&nbsp;же странице;</li>
                <li>Для перехода к&nbsp;электронной почте или телефонному номеру.</li>
              </ul>
            </p>
